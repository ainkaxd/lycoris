...
train_ds = tf.keras.utils.image_dataset_from_directory(
    ...
    label_mode="int"  # sparse equivalent
)
...
# Augmentation layer for train only (improved as suggested)
...
model_ckpt = callbacks.ModelCheckpoint(
    'best_model.keras',  # or use config['model_save_path'] if you update it
    save_best_only=True,
...
fine_tune_at = len(base_model.layers) - 100  # Unfreeze more layers
